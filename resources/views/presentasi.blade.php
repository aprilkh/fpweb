		...
		<div class="wrap-menu-header gradient1 trans-0-4">
			<div class="container h-full">
				<div class="wrap_header trans-0-3">
					...
					<div class="logo">
						<a href="index.html">
							<img src="{{asset('assets/images/icons/logo.png')}}" alt="IMG-LOGO" data-logofixed="images/icons/logo2.png">
						</a>
					</div>
	...
	<aside class="sidebar trans-0-4">
		...
		<div class="gallery-sidebar t-center p-l-60 p-r-60 p-b-40">
			...
			<div class="wrap-gallery-sidebar flex-w">
				...
				<a class="item-gallery-sidebar wrap-pic-w" href="{{asset('assets/images/photo-gallery-02.jpg')}}" data-lightbox="gallery-footer">
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(assets/images/master-slides-01.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
